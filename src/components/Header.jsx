...
const Header = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 bg-n8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm">
        <div className="flex items-ceter px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
